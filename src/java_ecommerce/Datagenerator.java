...
public class Datagenerator {
    ...
    public static void createProduct(){
        ...
        Product product1 =
                new Product(UUID.randomUUID(),"PS5",230.72,7,5,StaticConstants.CATEGORY_LIST.get(0).getId());

        Product product2 =
                new Product(UUID.randomUUID(),"XBOX",120.34,15,5,StaticConstants.CATEGORY_LIST.get(0).getId());

        Product product3 =
                new Product(UUID.randomUUID(),"Chair",30.78,85,85,StaticConstants.CATEGORY_LIST.get(1).getId());

        Product product4 =
                new Product(UUID.randomUUID(),"Milk",3.78,5,2,UUID.randomUUID());
